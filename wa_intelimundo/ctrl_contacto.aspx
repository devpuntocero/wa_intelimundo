<%@ Page Title="" Language="C#" MasterPageFile="~/mp_intelimundo.Master" AutoEventWireup="true" CodeBehind="ctrl_contacto.aspx.cs" Inherits="wa_intelimundo.ctrl_contacto" %>
        ...
        <ContentTemplate>
            <div class="section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center">Registro datos de Contacto</h2>
                        </div>
                    </div>
                    <div class="row">
